...
#ifndef MIR_CLIENT_WAYLAND_CLIENT_BUFFER_H_
#define MIR_CLIENT_WAYLAND_CLIENT_BUFFER_H_
...
private:
    std::shared_ptr<graphics::wayland::NativeBuffer> const creation_package;
...
#endif /* MIR_CLIENT_WAYLAND_CLIENT_BUFFER_H_ */
